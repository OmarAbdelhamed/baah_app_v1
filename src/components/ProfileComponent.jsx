...
const ProfileComponent = ({
  ...
  return (
    <View>
          ...
          <View style={styles.contentContainer}>
            <View style={styles.profileRow}>
              <TouchableOpacity onPress={handleChooseImage}>
                <Image
                  source={
                    { uri: profile.image } || require('../../assets/pp.png')
                  }
              ...
              <View style={styles.profileInfoContainer}>
                ...
                <Text style={styles.profileDetails}>
                  اخر تواجد قبل{' '}
                  {profile.active_status && profile.active_status.substring(12)}{' '}
                  دقائق
                </Text>
              </View>
            </View>
          ...
          {profile.marital_status_woman_man && (
            <TouchableOpacity style={styles.button}>
              ...
              <Text style={styles.buttonText}>
                ❤️ {profile.marital_status_woman_man}
              </Text>
            </TouchableOpacity>
          )}
      ...
      <View style={styles.groupParent}>
        {profile.daily_habits_woman &&
          profile.daily_habits_woman.map((item, key) => {
            return (
